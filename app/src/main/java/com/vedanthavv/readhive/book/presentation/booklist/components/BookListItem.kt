package com.vedanthavv.readhive.book.presentation.booklist.components
...
import com.vedanthavv.readhive.ui.theme.LightBlue
...
//                )
            ...
            Column(
                ...
                book.authors.firstOrNull()?.let { authorName ->
                    Text(text = authorName, style = MaterialTheme.typography.bodyLarge,
